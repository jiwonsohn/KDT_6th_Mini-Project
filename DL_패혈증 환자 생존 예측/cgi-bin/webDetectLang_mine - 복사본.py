...
def showHTML(data, msg):
    ...
    print(f"""
        ...
        <html lang="en">
         ...
         <body>
          <form>
            <input type='text' name='review' placeholder='리뷰 내용 입력', value={data[0]}><br/>
...
data = []
data.append(form.getvalue("review", default=""))
...
result = movieReviewPosNeg(mymodel, data[0], STOP_FILE, VOCAB_FILE, max_length)
