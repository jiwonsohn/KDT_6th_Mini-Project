        ...
        <html lang="en">
         ...
         <body>
          <form>
            ...
            <input type='text' name='count' placeholder='패혈증 발병이력 (1부터)', value={data[2]}><br/>
...
def detectLOD(data_input, model):
    ...
    # input data 성별 전처리
        ...
        result ="생존" if (pre_test > 0.9).item() else "사망"
...
## 저장경로
SAVE_PATH= r'C:\Users\KDP-43\Desktop\WEB\web_miniproject\model_py\model.data'
...
# msg =""
# if not '' in data:
result_input = detectLOD(data, SepsisLODModel)
