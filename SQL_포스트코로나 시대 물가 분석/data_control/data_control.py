...
data_isert('생필품지역별_동향(전체2019년)_정리.xls',2019,'C')
data_isert('생필품지역별_동향(전체2020년)_정리.xls',2020,'C')
data_isert('생필품지역별_동향(전체2021년)_정리.xls',2021,'C')
data_isert('생필품지역별_동향(전체2022년)_정리.xls',2022,'C')
data_isert('생필품지역별_동향(전체2023년_정리.xls',2023,'C')
